...
parser.add_argument('--nb-games', type=int, default=500)
...
parser.add_argument('--mcts-iterations', type=int, default=5009)
...
parser.set_defaults(multiprocessing=False, ignore_opponent_actions=False)
...
if __name__ == '__main__':
    ...
    s2 = f"ignore = {args.ignore_opponent_actions}, fpu = {args.fpu}, exploration_coef={args.exploration_coef}, pw_c = {args.pw_c}, pw_alpha = {args.pw_alpha}"
